...
const CandidatesGrid = () => {
  ...
  const candidates = [
    {
      ...
      bio: "Passionnée de mode depuis son plus jeune âge, Emma crée des designs innovants qui allient élégance et durabilité.",
    },
    {
      id: 2,
      name: "Sophie Martin",
      ...
      category: "Sport",
      image: "/public/candidate.jpg",
      bio: "Athlète accomplie en athlétisme, Sophie a remporté plusieurs médailles nationales et inspire les jeunes sportifs.",
    },
    {
      id: 3,
      name: "Léa Dubois",
      ...
      category: "Danse",
      image: "/public/candidate.jpg",
      bio: "Danseuse contemporaine, Léa exprime à travers ses chorégraphies des émotions profondes qui touchent tous les spectateurs.",
    },
    {
      id: 4,
      name: "Julia Petit",
      ...
      category: "Art",
      image: "/public/candidate.jpg",
      bio: "Artiste peintre autodidacte, Julia explore dans ses œuvres les thèmes de la nature et de l'identité.",
    },
    {
      id: 5,
      name: "Aurélie Moreau",
      ...
      category: "Mode",
      image: "/public/candidate.jpg",
      bio: "Styliste spécialisée dans la mode éthique, Aurélie révolutionne l'industrie avec ses créations responsables.",
    },
    {
      id: 6,
      name: "Camille Roux",
      ...
      category: "Sport",
      image: "/public/candidate.jpg",
      bio: "Championne de natation, Camille s'entraîne pour les prochaines compétitions internationales avec détermination.",
    },
    {
      id: 7,
      name: "Marie Bernard",
      ...
      category: "Danse",
      image: "/public/candidate.jpg",
      bio: "Formée au ballet classique, Marie combine tradition et modernité dans ses performances spectaculaires.",
    },
    {
      id: 8,
      name: "Clara Lemoine",
      ...
      category: "Art",
      image: "/public/candidate.jpg",
      bio: "Sculptrice talentueuse, Clara transforme des matériaux recyclés en œuvres d'art fascinantes.",
    },
    {
      id: 9,
      name: "Zoé Girard",
      ...
      category: "Mode",
      image: "/public/candidate.jpg",
      bio: "Designer de bijoux contemporains, Zoé puise son inspiration dans ses voyages à travers le monde.",
    },
    {
      id: 10,
      name: "Lucie Thomas",
      ...
      category: "Sport",
      image: "/public/candidate.jpg",
      bio: "Grimpeuse professionnelle, Lucie repousse constamment ses limites en relevant de nouveaux défis.",
    },
    {
      id: 11,
      name: "Inès Leroy",
      ...
      category: "Danse",
      image: "/public/candidate.jpg",
      bio: "Spécialiste de danse latine, Inès a remporté plusieurs concours internationaux grâce à son style unique.",
    },
    {
      id: 12,
      name: "Jade Bonnet",
      ...
      category: "Art",
      image: "/public/candidate.jpg",
      bio: "Photographe de talent, Jade capture des instants de vie avec une sensibilité remarquable.",
    },
    ...
    */
    ...Array.from({ length: 48 }, (_, i) => ({
      ...
      image: "/public/candidate.jpg",
      bio: `Biographie de la candidate ${
        i + 13
      }. Découvrez son parcours exceptionnel et ses ambitions.`,
    })),
  ];
  ...
  const filteredCandidates = candidates.filter((candidate) => {
    ...
    const matchesFilter =
      currentFilter === "Tous" || candidate.category === currentFilter;
    ...
    <div className="bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-6 text-gray-600">
          ...
          sur {filteredCandidates.length} candidates
        </div>
            ...
            >
              ...
              <div className="p-6 overflow-y-auto">
                ...
                <p className="text-gray-600 mb-6">
                  Découvrez le pitch de {selectedCandidate.name} et son parcours
                  exceptionnel.
                </p>
                  ...
                  <div className="lg:col-span-6 order-2 lg:order-1">
                    <div className="relative rounded-2xl overflow-hidden shadow-xl h-64 md:h-80 lg:h-[400px]">
                      <video
                        ref={videoRef}
                        className="w-full h-full object-cover"
                        poster="https://asset.cloudinary.com/dkp9ou5jo/af16ee33646ceb9b8b2b470950508e13"
                        controls={false}
                      >
                        <source
                          src="https://cdn.pixabay.com/video/2020/01/25/31569-387675206_tiny.mp4"
                          type="video/mp4"
                        />
                      ...
                      <div className="absolute bottom-4 left-4 right-4 flex items-center justify-between">
                        ...
                        <button
                          ...
                          className="bg-[#2AB4C4] hover:bg-[#1da3b3] text-white rounded-full w-12 h-12 flex items-center justify-center transition-all duration-300 shadow-lg hover:shadow-xl"
