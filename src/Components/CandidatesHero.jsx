      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="flex flex-col lg:flex-row">
          ...
          >
            ...
            >
              Soutenez votre candidate{" "}
              <span className="text-[#2AB4C4]">préférée</span>
            </motion.h1>
            ...
            >
              Découvrez nos candidates exceptionnelles et suivez l'évolution du
              concours jusqu'à l'annonce des résultats.
            </motion.p>
                ...
                <div className="p-6">
                  <div className="text-center mb-6">
                    ...
                    <p className="text-gray-600">
                      Suivez le décompte jusqu'à la clôture du concours.
                    </p>
                  </div>
                  ...
                  <div className="space-y-4 mb-6">
                    <div className="bg-amber-50 border-l-4 border-amber-400 p-4 rounded-r-lg">
                      ...
                      <p className="text-amber-700 text-sm">
                        Le vote se termine le 26 Mai 2025 à minuit.
                      </p>
                    </div>

                    <div className="bg-[#2AB4C4]/5 border-l-4 border-[#2AB4C4] p-4 rounded-r-lg">
                      <h4 className="font-medium text-[#2AB4C4] mb-1">
                        Annonce des résultats
                      </h4>
                      <p className="text-gray-700 text-sm">
                        Les gagnantes seront annoncées le 31 Mai 2025 lors de la
